-- Eliminar la base de datos jardineriav2 si existe
IF EXISTS (SELECT * FROM sys.databases WHERE name = 'jardineriav2')
BEGIN
    DROP DATABASE jardineriav2;
END;

-- Crear y usar la base de datos jardineriav2
CREATE DATABASE jardineriav2;
USE jardineriav2;
GO
...
-- Crear la tabla pago OK
CREATE TABLE pago (
  codigo_pago INT IDENTITY(1,1),
  forma_pago NVARCHAR(40) NOT NULL,
  CONSTRAINT pk_pago PRIMARY KEY (codigo_pago),
  CONSTRAINT ck_formapago_pago CHECK (forma_pago IN ('PayPal', 'Transferencia bancaria', 'Tarjeta de crédito', 'Efectivo', 'Cheque', 'Bizum', 'Criptomonedas', 'Pago contra reembolso'))
);
...
-- Crear la tabla pago_pedido OK
CREATE TABLE pago_pedido (
  id_transaccion NVARCHAR(50),
  codigo_pedido INT NOT NULL,
  codigo_pago INT NOT NULL,
  fecha_pago DATE NOT NULL,
  CONSTRAINT pk_pago_pedido PRIMARY KEY (id_transaccion),
  CONSTRAINT fk_pago_pedido_pedido FOREIGN KEY (codigo_pedido) REFERENCES pedido (codigo_pedido),
  CONSTRAINT fk_pago_pedido_codigo_pago FOREIGN KEY (codigo_pago) REFERENCES pago (codigo_pago)
);
GO

-- Insertar datos en la tabla pago
INSERT INTO pago (forma_pago) VALUES ('PayPal');
INSERT INTO pago (forma_pago) VALUES ('Transferencia bancaria');
INSERT INTO pago (forma_pago) VALUES ('Tarjeta de crédito');
INSERT INTO pago (forma_pago) VALUES ('Efectivo');
INSERT INTO pago (forma_pago) VALUES ('Cheque');
INSERT INTO pago (forma_pago) VALUES ('Bizum');
INSERT INTO pago (forma_pago) VALUES ('Criptomonedas');
INSERT INTO pago (forma_pago) VALUES ('Pago contra reembolso');
...
INSERT INTO cliente(codigo_cliente, nombre_cliente, nombre_contacto, apellido_contacto, telefono, fax, linea_direccion1, linea_direccion2, ciudad, region, pais, codigo_postal, codigo_empleado_rep_ventas, limite_credito) VALUES (1,'GoldFish Garden','Daniel G','GoldFish','5556901745','5556901746','False Street 52 2 A',NULL,'San Francisco',NULL,'Estados Unidos','24006',19,3000.00),
  (3,'Gardening Associates','Anne','Wright','5557410345','5557410346','Wall-e Avenue',NULL,'Miami','Miami','Estados Unidos','24010',19,6000.00),
  (4,'Gerudo Valley','Link','Flaute','5552323129','5552323128','Oaks Avenue nº22',NULL,'New York',NULL,'Estados Unidos','85495',22,12000.00),
  (5,'Tendo Garden','Akane','Tendo','55591233210','55591233211','Null Street nº69',NULL,'Miami',NULL,'Estados Unidos','696969',22,600000.00),
  (6,'Lasas S.A.','Antonio','Lasas','34916540145','34914851312','Calle Leganes 15',NULL,'Fuenlabrada','Madrid','España','28945',8,154310.00),
  (7,'Beragua','Jose','Bermejo','654987321','916549872','Calle pintor segundo','Getafe','Madrid','Madrid','España','28942',11,20000.00),
  (8,'Club Golf Puerta del hierro','Paco','Lopez','62456810','919535678','Calle sinesio delgado','Madrid','Madrid','Madrid','España','28930',11,40000.00),
  (9,'Naturagua','Guillermo','Rengifo','689234750','916428956','Calle majadahonda','Boadilla','Madrid','Madrid','España','28947',11,32000.00),
  (10,'DaraDistribuciones','David','Serrano','675598001','916421756','Calle azores','Fuenlabrada','Madrid','Madrid','España','28946',11,50000.00),
  (11,'Madrileña de riegos','Jose','Tacaño','655983045','916689215','Calle Lagañas','Fuenlabrada','Madrid','Madrid','España','28943',11,20000.00),
  (12,'Lasas S.A.','Antonio','Lasas','34916540145','34914851312','Calle Leganes 15',NULL,'Fuenlabrada','Madrid','España','28945',8,154310.00),
  (13,'Camunas Jardines S.L.','Pedro','Camunas','34914873241','34914871541','Calle Virgenes 45','Calle Princesas 2 1ºB','San Lorenzo del Escorial','Madrid','España','28145',8,16481.00),
  (14,'Dardena S.A.','Juan','Rodriguez','34912453217','34912484764','Calle Nueva York 74',NULL,'Madrid','Madrid','España','28003',8,321000.00),
  (15,'Jardin de Flores','Javier','Villar','654865643','914538776','Calle  Oña 34',NULL,'Madrid','Madrid','España','28950',30,40000.00),
  (16,'Flores Marivi','Maria','Rodriguez','666555444','912458657','Calle Leganes24',NULL,'Fuenlabrada','Madrid','España','28945',5,1500.00),
  (17,'Flowers, S.A','Beatriz','Fernandez','698754159','978453216','Calle Luis Salquillo4',NULL,'Montornes del valles','Barcelona','España','24586',5,3500.00),
  (18,'Naturajardin','Victoria','Cruz','612343529','916548735','Plaza Magallón 15',NULL,'Madrid','Madrid','España','28011',30,5050.00),
  (19,'Golf S.A.','Luis','Martinez','916458762','912354475','Calle Estancado',NULL,'Santa cruz de Tenerife','Islas Canarias','España','38297',12,30000.00),
  (20,'Americh Golf Management SL','Mario','Suarez','964493072','964493063','Calle Letardo',NULL,'Barcelona','Cataluña','España','12320',12,20000.00),
  (21,'Aloha','Cristian','Rodrigez','916485852','914489898','Calle Roman 3',NULL,'Canarias','Canarias','España','35488',12,50000.00),
  (22,'El Prat','Francisco','Camacho','916882323','916493211','Avenida Tibidabo',NULL,'Barcelona','Cataluña','España','12320',12,30000.00),
  (23,'Sotogrande','Maria','Santillana','915576622','914825645','Calle Paseo del Parque',NULL,'Sotogrande','Cadiz','España','11310',12,60000.00),
  (24,'Vivero Humanes','Federico','Gomez','654987690','916040875','Calle Miguel Echegaray 54',NULL,'Humanes','Madrid','España','28970',30,7430.00),
  (25,'Fuenla City','Tony','Muñoz Mena','675842139','915483754','Calle Callo 52',NULL,'Fuenlabrada','Madrid','España','28574',5,4500.00),
  ...
  (27,'Jardinerías Matías SL','Matías','San Martín','916544147','917897474','Calle Francisco Arce, Nº44','Bustarviejo','Madrid','Madrid','España','37845',9,100500.00),
  (28,'Agrojardin','Benito','Lopez','675432926','916549264','Calle Mar Caspio 43',NULL,'Getafe','Madrid','España','28904',30,8040.00),
  (29,'Top Campo','Joseluis','Sanchez','685746512','974315924','Calle Ibiza 32',NULL,'Humanes','Madrid','España','28574',5,5500.00),
  (30,'Jardineria Sara','Sara','Marquez','675124537','912475843','Calle Lima 1',NULL,'Fuenlabrada','Madrid','España','27584',5,7500.00),
  (31,'Campohermoso','Luis','Jimenez','645925376','916159116','Calle Peru 78',NULL,'Fuenlabrada','Madrid','España','28945',30,3250.00),
  (32,'Francia telecom','FraÃ§ois','Toulou','(33)5120578961','(33)5120578961','6 place d Alleray 15Ã¨me',NULL,'Paris',NULL,'Francia','75010',16,10000.00),
  (33,'Musée du Louvre','Pierre','Delacroux','(33)0140205050','(33)0140205442','Quai du Louvre',NULL,'Paris',NULL,'Francia','75058',16,30000.00),
  ...
  (37,'The Magic Garden','Richard','Mcain','926523468','9364875882','Lihgting Park',NULL,'London','London','Reino Unido','65930',18,10000.00),
...
-- Insertar datos en la tabla pedido con fechas actualizadas
INSERT INTO pedido(codigo_pedido, fecha_pedido, fecha_esperada, fecha_entrega, estado, comentarios, codigo_cliente) VALUES 
(1,'2022-05-20','2022-05-22','2022-05-22','Entregado','Pagado a plazos',5),
(2,'2024-06-15','2024-06-20','2024-06-18','Entregado','La entrega llego antes de lo esperado',5),
(3,'2025-02-11','2025-02-16',NULL,'Rechazado','Limite de crédito superado',5),
(4,'2025-09-12','2025-09-18',NULL,'Pendiente',NULL,5),
(8,'2025-07-01','2025-07-06','2025-07-06','Entregado','El cliente paga la mitad con tarjeta y la otra mitad con efectivo, se le realizan dos facturas',1),
(9,'2025-08-14','2025-08-19','2025-08-20','Entregado','El cliente comprueba la integridad del paquete, todo correcto',1),
(10,'2025-09-07','2025-09-12',NULL,'Pendiente','El cliente llama para confirmar la fecha - Esperando al proveedor',3),
(11,'2025-09-12','2025-09-19',NULL,'Pendiente','El cliente requiere que el pedido se le entregue de 16:00h a 22:00h',1),
(12,'2025-09-14','2025-09-19',NULL,'Pendiente','El cliente requiere que el pedido se le entregue de 9:00h a 13:00h',1),
(13,'2025-09-04','2025-09-06','2025-09-07','Entregado',NULL,7),
(14,'2025-08-24','2025-08-24',NULL,'Rechazado','mal pago',7),
(15,'2025-09-01','2025-09-04','2025-09-03','Entregado',NULL,7),
(16,'2025-08-28','2025-08-29','2025-09-07','Entregado',NULL,7),
(17,'2025-08-30','2025-08-31','2025-09-03','Entregado','mal estado',7),
(18,'2025-08-27','2025-08-28','2025-08-29','Entregado',NULL,9),
(19,'2025-09-10','2025-10-04',NULL,'Pendiente','entregar en murcia',9),
(20,'2025-09-12','2025-10-07',NULL,'Pendiente',NULL,9),
(21,'2025-09-01','2025-09-01','2025-09-01','Rechazado','mal pago',9),
(22,'2025-09-03','2025-09-03','2025-09-05','Entregado',NULL,9),
(23,'2025-08-22','2025-09-02',NULL,'Rechazado','El pedido fue anulado por el cliente',5),
(24,'2027-03-06','2027-03-23','2027-03-17','Entregado',NULL,14),
(25,'2026-09-24','2026-09-30',NULL,'Rechazado','El cliente carece de saldo en la cuenta asociada',1),
(26,'2026-10-28','2026-11-03',NULL,'Rechazado','El cliente anula la operación para adquirir más producto',3),
(27,'2026-10-29','2026-11-04',NULL,'Entregado','El pedido aparece como entregado, pero no sabemos en qué fecha',3),
(28,'2026-11-01','2026-11-08','2026-11-11','Entregado','El cliente se queja bastante de la espera asociada al producto',3),
(29,'2025-04-03','2025-05-03','2025-05-03','Rechazado','El cliente no está conforme con el pedido',14),
(30,'2025-04-05','2025-05-05','2025-05-02','Entregado',NULL,13),
(31,'2025-05-06','2025-06-01','2025-06-05','Rechazado','El cliente ha rechazado por llegar 5 días tarde',13),
(32,'2023-07-29','2023-08-10','2023-08-18','Entregado','Entrega tardía, el cliente puso reclamacion',4),
(33,'2023-11-11','2023-12-16',NULL,'Rechazado','El pedido fue anulado por el cliente',4),
(34,'2024-02-11','2025-02-19','2025-02-19','Entregado','Pagado a plazos',4),
(35,'2025-09-12','2026-09-22',NULL,'Rechazado','Limite de crédito superado',4),
(36,'2025-06-17','2025-08-17','2025-08-12','Entregado',NULL,14),
(37,'2025-07-05','2026-07-15',NULL,'Pendiente','El pedido nunca llego a su destino',4),
(38,'2026-09-07','2026-09-08','2026-09-09','Entregado',NULL,19),
(39,'2026-09-08','2026-09-09','2026-09-11','Pendiente',NULL,19),
(40,'2026-09-11','2026-09-12','2026-09-15','Rechazado',NULL,19),
(41,'2026-09-14','2026-09-15','2026-09-15','Entregado',NULL,19),
(42,'2026-09-24','2026-09-25','2026-09-29','Entregado',NULL,19),
(43,'2026-09-27','2026-09-28','2026-09-30','Pendiente',NULL,23),
(44,'2026-09-28','2026-09-29','2026-10-02','Pendiente',NULL,23),
(45,'2026-10-03','2026-09-06','2026-09-09','Entregado',NULL,23),
(46,'2026-10-05','2026-09-06','2026-09-07','Rechazado',NULL,23),
(47,'2026-10-17','2026-09-19','2026-09-19','Entregado',NULL,23),
(48,'2025-09-19','2025-10-02','2025-10-01','Entregado','Según el Cliente, el pedido llegó defectuoso',26),
(49,'2025-03-14','2025-03-24','2025-04-01','Entregado','El pedido llegó 1 día tarde, pero no hubo queja por parte de la empresa compradora',26),
(50,'2025-09-19','2026-02-01',NULL,'Pendiente','Al parecer, el pedido se ha extraviado a la altura de Sotalbo (Ávila)',26),
(51,'2025-06-03','2025-06-16','2025-06-16','Entregado','Todo se entregó a tiempo y en perfecto estado, a pesar del pésimo estado de las carreteras.',26),
(52,'2025-08-09','2025-08-23',NULL,'Pendiente','El transportista ha llamado a Eva María para indicarle que el pedido llegará más tarde de lo esperado.',26),
(53,'2025-07-17','2025-07-31','2025-08-02','Entregado','El envió llego dos días más tarde debido al mal tiempo',13),
(54,'2026-07-13','2026-08-13',NULL,'Pendiente',NULL,14),
(55,'2025-08-12','2025-09-12','2025-09-13','Entregado','Retrasado 1 día por problemas de transporte',14),
(56,'2025-08-21','2026-09-22',NULL,'Rechazado','El cliente a anulado el pedido el día 2026-09-14',13),
(57,'2026-07-07','2026-08-07',NULL,'Pendiente',NULL,13),
(58,'2026-07-26','2026-08-02','2026-08-01','Entregado','Todo correcto',3),
(59,'2025-07-01','2025-07-06','2025-07-06','Entregado','El cliente paga la mitad con tarjeta y la otra mitad con efectivo, se le realizan dos facturas',1),
(60,'2025-08-14','2025-08-19','2025-08-20','Entregado','El cliente comprueba la integridad del paquete, todo correcto',1),
(61,'2026-07-07','2026-07-12',NULL,'Pendiente','El cliente llama para confirmar la fecha - Esperando al proveedor',3),
(62,'2026-07-12','2026-07-19',NULL,'Pendiente','El cliente requiere que el pedido se le entregue de 16:00h a 22:00h',1),
(63,'2026-07-14','2026-07-19',NULL,'Pendiente','El cliente requiere que el pedido se le entregue de 9:00h a 13:00h',1),
(64,'2026-07-26','2026-08-02','2026-08-01','Entregado','Todo correcto',1),
(65,'2026-08-04','2026-08-10',NULL,'Rechazado','El cliente carece de saldo en la cuenta asociada',1),
(66,'2026-08-08','2026-08-14',NULL,'Rechazado','El cliente anula la operación para adquirir mas producto',3),
(67,'2026-08-09','2026-08-15',NULL,'Entregado','El pedido aparece como entregado pero no sabemos en que fecha',3),
(68,'2026-08-12','2026-08-19','2026-08-22','Entregado','El cliente se queja bastante de la espera asociada al producto',3),
(74,'2026-07-06','2026-07-14',NULL,'Rechazado','El pedido no llego el día que quería el cliente por fallo del transporte',15),
(75,'2026-07-03','2026-07-05','2026-07-05','Entregado','El pedido llego perfectamente',15),
(76,'2025-07-17','2025-07-25','2025-07-25','Entregado',NULL,15),
(77,'2026-07-05','2026-07-10',NULL,'Pendiente','El pedido no pudo ser entregado por problemas meteorologicos',15),
(78,'2025-08-17','2025-08-19','2025-08-19','Entregado','Fue entregado, pero faltaba mercancía que será entregada otro dia',15),
(79,'2026-07-04','2026-07-05','2026-07-05','Entregado',NULL,28),
(80,'2026-07-27','2026-07-28',NULL,'Pendiente','No terminó el pago',28),
(81,'2026-07-20','2026-07-26',NULL,'Rechazado','Los producto estaban en mal estado',28),
(82,'2026-07-22','2026-07-31','2026-07-31','Entregado','El pedido llego un poco más tarde de la hora fijada',28),
(83,'2026-07-26','2026-07-30',NULL,'Entregado',NULL,28),
(89,'2024-06-07','2024-08-15','2024-08-12','Entregado','La entrega se realizó días antes de la fecha esperada por lo que el cliente quedo satisfecho',35),
(90,'2026-08-09','2025-08-19',NULL,'Pendiente','Debido a la nevada caída en la sierra, el pedido no podrá llegar hasta el día ',27),
(91,'2026-09-20','2026-10-01','2026-09-29','Entregado','Todo se entregó a su debido tiempo, incluso con un día de antelación',27),
(92,'2026-10-21','2026-11-01','2026-11-04','Entregado','El pedido se entregó tarde debido a la festividad celebrada en España durante esas fechas',27),
(93,'2026-11-05','2026-12-02','2026-11-19','Entregado','El pedido se entregó antes de lo esperado.',27),
(94,'2027-06-20','2027-07-03',NULL,'Pendiente','El pedido está en camino.',27),
(95,'2025-07-06','2025-07-21','2025-07-21','Entregado',NULL,35),
(96,'2025-09-22','2025-10-14','2025-10-15','Entregado','La entrega se retrasó un dia',35),
(97,'2025-06-10','2025-07-27','2025-07-27','Entregado',NULL,35),
(98,'2026-07-10','2026-08-15',NULL,'Pendiente',NULL,35),
(99,'2026-08-17','2026-08-29',NULL,'Pendiente',NULL,16),
(100,'2026-07-12','2026-07-17','2026-07-17','Entregado','El pedido llego perfectamente',16),
(101,'2026-09-09','2026-09-29',NULL,'Rechazado','El pedido fue rechazado por el cliente',16),
(102,'2025-08-30','2025-09-10','2025-09-10','Entregado','Pago pendiente',16),
(103,'2026-07-17','2026-07-22','2026-07-26','Pendiente',NULL,30),
(104,'2026-09-04','2026-09-08','2026-09-08','Entregado',NULL,30),
(105,'2026-08-16','2026-08-22',NULL,'Rechazado','el producto ha sido rechazado por la pésima calidad',30),
(106,'2026-11-15','2026-11-17','2026-11-22','Pendiente',NULL,30),
(107,'2026-10-08','2026-10-12','2026-10-12','Entregado',NULL,30),
(108,'2026-10-11','2026-10-17','2026-10-17','Entregado',NULL,16),
(109,'2023-11-27','2024-02-29','2024-02-29','Entregado',NULL,38),
(110,'2024-09-21','2024-10-26','2024-10-26','Entregado',NULL,38),
(111,'2025-09-07','2025-10-02','2025-10-02','Entregado',NULL,36),
(112,'2026-09-07','2026-10-08','2026-11-09','Pendiente',NULL,36),
(113,'2025-06-30','2025-07-11','2026-09-11','Rechazado','El producto ha sido rechazado por la tardanza del envio',36),
(114,'2026-07-17','2026-07-31','2026-08-02','Entregado','El envío llego dos días más tarde debido al mal tiempo',36),
(115,'2025-07-31','2026-09-28','2026-10-29','Pendiente',NULL,36),
(116, '2025-02-28', '2025-04-03', '2025-04-03', 'Entregado', NULL, 38),
(117,'2025-04-27','2025-06-03',NULL,'Rechazado','El pedido ha sido rechazado por la acumulación de pago pendientes del cliente',38),
(118,'2025-02-15','2025-02-27',NULL,'Pendiente',NULL,16),
(119,'2025-01-10','2025-01-15','2025-01-15','Entregado','El pedido llego perfectamente',16),
(120,'2025-03-07','2025-03-27',NULL,'Rechazado','El pedido fue rechazado por el cliente',16),
(121,'2024-12-28','2025-01-08','2025-01-08','Entregado','Pago pendiente',16),
(122,'2025-04-09','2025-04-15','2025-04-15','Entregado',NULL,16),
(123,'2025-01-15','2025-01-20','2025-01-24','Pendiente',NULL,30),
(124,'2025-03-02','2025-03-06','2025-03-06','Entregado',NULL,30),
(125,'2025-02-14','2025-02-20',NULL,'Rechazado','el producto ha sido rechazado por la pésima calidad',30),
(126,'2025-05-13','2025-05-15','2025-05-20','Pendiente',NULL,30),
(127,'2025-04-06','2025-04-10','2025-04-10','Entregado',NULL,30),
(128,'2024-11-10','2024-12-10','2024-12-29','Rechazado','El pedido ha sido rechazado por el cliente por el retraso en la entrega',38);
...
-- Insertar datos en pago_pedido para pedidos con estado 'Entregado'
INSERT INTO pago_pedido (id_transaccion, codigo_pedido, codigo_pago, fecha_pago) VALUES
('ak-std-000001', 1, 3, '2023-10-05'),
('ak-std-000002', 2, 1, '2023-10-10'),
('ak-std-000008', 8, 2, '2023-11-14'),
('ak-std-000067', 67, 1, '2026-08-15'),
('ak-std-000009', 9, 4, '2023-12-28'),
('ak-std-000013', 13, 5, '2023-01-15'),
('ak-std-000015', 15, 6, '2023-01-11'),
('ak-std-000016', 16, 3, '2023-01-15'),
('ak-std-000017', 17, 3, '2023-01-11'),
('ak-std-000018', 18, 3, '2023-01-07'),
('ak-std-000022', 22, 1, '2023-01-13'),
('ak-std-000024', 24, 2, '2023-07-25'),
('ak-std-000027', 27, 4, '2023-02-13'),
('ak-std-000028', 28, 5, '2023-02-20'),
('ak-std-000030', 30, 6, '2023-08-31'),
('ak-std-000036', 36, 4, '2023-12-10'),
('ak-std-000038', 38, 4, '2023-03-07'),
('ak-std-000041', 41, 3, '2023-03-13'),
('ak-std-000042', 42, 1, '2023-03-27'),
('ak-std-000045', 45, 2, '2023-03-07'),
('ak-std-000047', 47, 4, '2023-03-17'),
('ak-std-000048', 48, 5, '2023-03-29'),
('ak-std-000049', 49, 6, '2023-07-30'),
('ak-std-000051', 51, 1, '2023-10-14'),
('ak-std-000053', 53, 1, '2023-11-09'),
('ak-std-000055', 55, 3, '2023-01-11'),
('ak-std-000058', 58, 1, '2023-01-30'),
('ak-std-000059', 59, 2, '2023-11-14'),
('ak-std-000060', 60, 4, '2023-12-28'),
('ak-std-000064', 64, 5, '2023-01-30'),
('ak-std-000075', 75, 6, '2023-01-13'),
('ak-std-000076', 76, 5, '2023-11-23'),
('ak-std-000079', 79, 5, '2023-01-13'),
('ak-std-000082', 82, 3, '2023-01-29'),
('ak-std-000083', 83, 1, '2023-01-28'),
('ak-std-000089', 89, 2, '2023-12-10'),
('ak-std-000091', 91, 4, '2023-03-27'),
('ak-std-000092', 92, 5, '2023-05-03'),
('ak-std-000093', 93, 6, '2023-05-17'),
('ak-std-000095', 95, 3, '2023-01-19'),
('ak-std-000096', 96, 1, '2023-04-13'),
('ak-std-000097', 97, 3, '2023-11-25'),
('ak-std-0000100', 100, 1, '2023-01-15'),
('ak-std-0000104', 104, 2, '2023-03-06'),
('ak-std-0000107', 107, 4, '2023-04-10'),
('ak-std-0000108', 108, 5, '2023-04-15'),
('ak-std-0000109', 109, 6, '2023-07-28'),
('ak-std-0000110', 110, 2, '2023-04-24'),
('ak-std-0000111', 111, 6, '2023-03-30'),
('ak-std-0000114', 114, 3, '2023-01-31'),
('ak-std-0000116', 116, 1, '2023-08-01'),
('ak-std-0000122', 122, 2, '2023-04-15'),
('ak-std-000032', 32, 2, '2023-08-18'),
('ak-std-000034', 34, 4, '2025-02-19'),
('ak-std-000068', 68, 5, '2026-08-22'),
('ak-std-000078', 78, 6, '2025-08-19'),
('ak-std-0000102', 102, 2, '2025-09-10'),
('ak-std-0000119', 119, 6, '2025-01-15'),
('ak-std-0000121', 121, 3, '2025-01-08'),
('ak-std-0000124', 124, 1, '2025-03-06'),
('ak-std-0000127', 127, 2, '2025-04-10');
...
SELECT
	...
	fecha_entrega
FROM pedido
WHERE 2 <= DATEDIFF(day, fecha_entrega, fecha_esperada);
...
SELECT
	...
	estado
FROM pedido
WHERE (fecha_pedido BETWEEN '2025-01-01' AND '2025-12-31') AND (estado = 'Rechazado');
...
SELECT 
	...
	CONCAT(nombre, apellido1, apellido2) AS nobre_completo_empleado,
...
SELECT
	...
	producto.gama
FROM producto
INNER JOIN linea_pedido ON producto.codigo_producto = linea_pedido.codigo_producto
INNER JOIN pedido ON linea_pedido.codigo_pedido = pedido.codigo_pedido
INNER JOIN cliente ON pedido.codigo_cliente = cliente.codigo_cliente
...
--Ejercicio_13
SELECT 
	empleado.nombre + ' ' + empleado.apellido1  + ' ' + empleado.apellido2 AS nobre_empleado,
	jefe.nombre + ' ' + jefe.apellido1 + ' ' + jefe.apellido2 AS nombre_jefe,
	jefe_jefe.nombre + ' ' + jefe_jefe.apellido1 + ' ' + jefe_jefe.apellido2 AS nombre_jefe_jefe
FROM empleado
